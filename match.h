...
void Find2DMatches(vector<vector<LOLAShot> > &trackPts, string cubFilename,  vector<Vector2>&matchArray, 
                   Vector2 matchWindowHalfSize, vector<Vector<float, 6> > &initTransfArray,  vector<float> &matchingErrorArray);
