                    ...
                    struct TilingParams &tileParams)
{
  ...
  Vector2 leftTopPix;
  leftTopPix(0) = tileParams.back_xl;
  leftTopPix(1) = tileParams.back_yt;
  ...
  cout<<"assembledWidth="<<assembledWidth<<", assembledHeight="<<assembledHeight<<endl;
  ...
  Vector2 point = backGeo.pixel_to_point(leftTopPix);
  ...
  cout.precision(12);
  cout<<"COMPUTE_ASSEMBLED_DEM: assembled DEM TILE transform:"<<endl;
  ...
  cout<<"COMPUTE_ASSEMBLED_DEM: (with padding) backLeftTopPix_x="<<leftTopPix(0)<<", backLeftTopPix_y="<<leftTopPix(1)<<", w="<<assembledWidth<<", h="<<assembledHeight<<endl;
  cout<<"COMPUTE_ASSEMBLED_DEM: bestDeltaLonLat="<<bestDeltaLonLat<<endl;
		    ...
		    struct RegistrationParams registrationParams, struct TilingParams &tileParams)
{
  ...
  cout<<"COMPUTE_ASSEMBLED_DRG: backLeftTopPix (includes padding) ="<<backLeftTopPix<<endl;
  Vector2 point = /*backGeo*/assembledGeo.pixel_to_point(backLeftTopPix);
  H(0,2) = point(0);
  H(1,2) = point(1);

  cout.precision(12);
  cout<<"COMPUTE_ASSEMBLED_DRG: assembled DRG TILE transform:"<<endl;
  cout<<"H(0,0)="<<H(0,0)<<endl;
  cout<<"H(0,1)="<<H(0,1)<<endl;
  cout<<"H(0,2)="<<H(0,2)<<endl;
  cout<<"H(1,0)="<<H(1,0)<<endl;
  ...
  cout<<"COMPUTE_ASSEMBLED_DRG: (with padding) backLeftTopPix_x="<<backLeftTopPix(0)<<", backLeftTopPix_y="<<backLeftTopPix(1)<<", w="<<assembledWidth<<", h="<<assembledHeight<<endl;
