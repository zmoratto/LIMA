...
#A15_DEM=`ls -d -1 /Users/anefian/projects/LMMP/LMMP_delivery/2010_1112_Apollo15_DEM/*.tif`
#echo $A15_DEM

#A16_DEM=`ls -d -1 /Users/anefian/projects/LMMP/LMMP_delivery/2010_0902_Apollo16_DEM/*.tif`
#echo $A16_DEM
...
#echo ../data/Apollo15-LOLA/*.csv |xargs -n 1 -I {} -P 2 ./lidar2dem  -l {} $A15_DEM
