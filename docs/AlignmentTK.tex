...
\begin{enumerate}
	...
	\item{make install} - make sure that usr/local/bin is in \$PATH. Otherwise, change CMAKE\_INSTALL\_PREFIX by ccmake .. in the "build" directory, then executable files will be generated in CMAKE\_INSTALL\_PREFIX/bin directory.
\end{enumerate}
